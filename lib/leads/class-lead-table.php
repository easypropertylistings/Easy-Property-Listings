...
/**
 * EPL_Lead_Reports_Table Class
 *
 * Renders the Lead Reports table
 *
 * @since 2.4
 */
class EPL_Lead_Reports_Table extends WP_List_Table {
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			...
			case 'num_listings' :
				$value = esc_html( $item['num_listings'] ) ;
				break;
	...
	public function column_name( $item ) {
		...
		$actions     = array(
			...
			'delete' => '<a href="' . admin_url( 'admin.php?page=epl-leads&view=delete&id=' . $item['id'] ) . '">' . __( 'Delete', 'epl' ) . '</a>'
		);
	...
	public function get_columns() {
		...
		return apply_filters( 'epl_report_lead_columns', $columns );
	 ...
	 *   Database API
	 * @return array $reports_data All the data for lead reports
	 */
	 ...
	 * @access public
	 * @since 2.4
	 * @uses EPL_Lead_Reports_Table::get_columns()
	 * @uses WP_List_Table::get_sortable_columns()
	 * @uses EPL_Lead_Reports_Table::get_pagenum()
	 * @uses EPL_Lead_Reports_Table::get_total_leads()
	 * @return void
	 */
