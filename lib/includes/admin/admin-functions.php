...
/**
 * Offers presented on dashboard widget, removed if extension is present and activated
 *
 * @since 3.1
 */
...
/**
 * Offers presented on post types, removed if extension is present and activated
 *
 * @since 3.1
 */
function epl_dashboard_widget_offer_post_types () {
	...
	$service_banners = array(
		array(
			'url' => 'https://easypropertylistings.com.au/extensions/?utm_source=offers&utm_medium=description_tab&utm_content=extensions_link&utm_campaign=epl_extensions',
			'img' => 'banner-dash-wide-store.png',
			'alt' => __('Browse the extension store', 'easy-property-listings' ),
			'width'	=> 125,
		),
		array(
			'url' => 'https://easypropertylistings.com.au/extensions/advanced-mapping/?utm_source=offers&utm_medium=description_tab&utm_content=extensions_link&utm_campaign=epl_extension_advanced_map',
			'img' => 'offer-advanced-mapping.png',
			'alt' => __('Advanced Mapping', 'easy-property-listings' ),
			'width'	=> 175,
		),
		array(
			'url' => 'https://easypropertylistings.com.au/extensions/sliders/?utm_source=offers&utm_medium=description_tab&utm_content=extensions_link&utm_campaign=epl_extension_sliders',
			'img' => 'offer-sliders.png',
			'alt' => __('Sliders extension', 'easy-property-listings' ),
			'width'	=> 175,
		),
		array(
			'url' => 'https://easypropertylistings.com.au/extensions/staff-directory/?utm_source=offers&utm_medium=description_tab&utm_content=extensions_link&utm_campaign=epl_extension_staff_directory',
...
function epl_dashboard_widget_offer_post_types_last () {
	...
	echo '<a target="_blank" href="https://easypropertylistings.com.au/extensions/?utm_source=offers&utm_medium=description_tab&utm_content=extensions_link&utm_campaign=epl_extension_store">
			<img style="display: block; float: right; margin: 0.5em 0 0.5em 0.5em" width="125" src="' . plugins_url( 'lib/assets/images/' . 'banner-dash-wide-store-remove.png' , EPL_PLUGIN_FILE ) .'" alt="' . __('Purchase and activate any extension to remove these ads', 'easy-property-listings' ) . '"/>
		</a>';
	?>
<?php
}
...
function epl_extension_notice_offer() {
	...
	if( is_epl_core_post() == true || $screen->id == 'easy-property-listings_page_epl-reports' || $screen->id == 'easy-property-listings_page_epl-contacts' || $screen->id == 'toplevel_page_epl-general' ) {
		...
		echo '<div class="notice notice-success" style="max-height: 130px; overflow: hidden;">';
			...
			echo '<div class="epl-offers epl-offers-right" style="box-sizing: border-box; width: 15%; float: left;  height: 120px">';
