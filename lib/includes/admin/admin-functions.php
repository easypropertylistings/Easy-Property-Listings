...
/**
 * Update the property_price_search when saving or updating an EPL post
 *
 * @since       3.3
 */
function epl_sync_property_price_search() {
...
add_action('save_post','epl_sync_property_price_search',40);
