 ...
 *
 * @package     EPL
 * @subpackage  Admin/Classes/ContactsTable
...
class EPL_Contact_Reports_Table extends WP_List_Table {
	...
	public function process_bulk_action() {
		...
		if ( 'bulk-delete' === $this->current_action() ) {
			...
			$delete_ids = isset( $_GET['bulk-delete'] ) ? (array) array_map( 'absint', wp_unslash( $_GET['bulk-delete'] ) ) : array();
	...
	public function extra_tablenav( $which ) {
		if ( 'top' === $which ) {
			...
			<div class="alignleft actions bulkactions">
				...
				if ( $cats ) {
					?>
					<select aria-label="<?php esc_attr_e( 'Category Filter', 'easy-property-listings' ); ?>" name="cat_filter" class="epl_contact_type_filter">
