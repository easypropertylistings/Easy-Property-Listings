		...
		if ( 'property' == $this->post_type || 'land' == $this->post_type || 'rural' == $this->post_type){ 
			...
			if( $this->get_property_com_rent() != '' && $this->get_property_meta('property_com_listing_type') == 'both') {
				$price_plain_value .= 
					'</br>'.
						__('For Lease', 'epl').' ' . 
						$this->get_property_com_rent() . ' '.
						__($rent_lease_type,'epl');
			} elseif($this->get_property_com_rent() != '' && $this->get_property_meta('property_com_listing_type') == 'lease') {
				$price_plain_value = ' '.__('For Lease', 'epl').' ' . $this->get_property_com_rent() . ' '.__($rent_lease_type,'epl');
			}
		}
	...
	public function get_price() {
		...
		if ( 'property' == $this->post_type || 'land' == $this->post_type || 'rural' == $this->post_type){
			...
			if( $this->get_property_com_rent() != '' && $this->get_property_meta('property_com_listing_type') == 'both') {
				...
				$price .= '<div class="epl-clear"></div><span class="page-price">'.__('For Lease', 'epl').' ' . $this->get_property_com_rent() . ' '.__($rent_lease_type, 'epl').'</span>';
			} elseif($this->get_property_com_rent() != '' && $this->get_property_meta('property_com_listing_type') == 'lease') {
				$price = '<span class="page-price">'.__('For Lease', 'epl').' ' . $this->get_property_com_rent() . ' '.__($rent_lease_type, 'epl').'</span>';
			}
		}
		return $price;
	}
	...
	public function get_l_price() {
		...
		if ( 'property' == $this->post_type || 'land' == $this->post_type || 'rural' == $this->post_type){ 
			...
			if( $this->get_property_com_rent() != '' && $this->get_property_meta('property_com_listing_type') == 'both') {
				...
				$l_price .= '<li class="page-price">'.__('For Lease', 'epl').' ' . $this->get_property_com_rent() . ' '.__($rent_lease_type, 'epl').'</li>';
			} elseif($this->get_property_com_rent() != '' && $this->get_property_meta('property_com_listing_type') == 'lease') {
				$l_price = '<li class="page-price">'.__('For Lease', 'epl').' ' . $this->get_property_com_rent() . ' '.__($rent_lease_type, 'epl').'</li>';
			}
		}
