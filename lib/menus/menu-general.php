		...
		array(
			...
			'fields'	=>	array(
				array(
					...
					'type'	=>	'checkbox',
					'opts'	=>	$epl_post_types,
					'help'	=>	__('Refresh the page to see your new activated listing types. Note: If they are not visible on the front end Dashboard > Settings > Permalinks and press Save Changes.')
				),
