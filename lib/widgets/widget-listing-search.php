...
class EPL_Widget_Property_Search extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		<div class="epl-search-form">
			<form action="" method="get">
				...
				<?php
				if ( !$instance['disable_car'] && !$instance['disable_bath'] ) { // Remove Wrapper Div if both disabled
				?>
				<div class="fm-block bdr-btm">
				<?php } ?>	
	...
	function update($new_instance, $old_instance) {		
		...
		$instance['disable_bed'] = strip_tags($new_instance['disable_bed']);
		$instance['disable_bath'] = strip_tags($new_instance['disable_bath']);
		$instance['disable_car'] = strip_tags($new_instance['disable_car']);
		$instance['disable_other'] = strip_tags($new_instance['disable_other']);
		return $instance;
	}
	...
	function form($instance) {
		...
		$disable_price			=	esc_attr($instance['disable_price']);
		$disable_bed			=	esc_attr($instance['disable_bed']);
		$disable_bath			=	esc_attr($instance['disable_bath']);
		$disable_car			=	esc_attr($instance['disable_car']);
		$disable_other			=	esc_attr($instance['disable_other']);
		?>
			<p>
			...
			<p><strong><?php _e('Tick to Remove from Search', 'epl'); ?></strong></p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('disable_house_category'); ?>"><?php _e('House Category', 'epl'); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id('disable_price'); ?>" name="<?php echo $this->get_field_name('disable_price'); ?>" type="checkbox" value="1" <?php if(isset($disable_price) && $disable_price) { echo 'checked="checked"'; } ?> />
				<label for="<?php echo $this->get_field_id('disable_price'); ?>"><?php _e('Price', 'epl'); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id('disable_bed'); ?>" name="<?php echo $this->get_field_name('disable_bed'); ?>" type="checkbox" value="1" <?php if(isset($disable_bed) && $disable_bed) { echo 'checked="checked"'; } ?> />
				<label for="<?php echo $this->get_field_id('disable_bed'); ?>"><?php _e('Bedroom', 'epl'); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id('disable_bath'); ?>" name="<?php echo $this->get_field_name('disable_bath'); ?>" type="checkbox" value="1" <?php if(isset($disable_bath) && $disable_bath) { echo 'checked="checked"'; } ?> />
				<label for="<?php echo $this->get_field_id('disable_bath'); ?>"><?php _e('Bathroom', 'epl'); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id('disable_car'); ?>" name="<?php echo $this->get_field_name('disable_car'); ?>" type="checkbox" value="1" <?php if(isset($disable_car) && $disable_car) { echo 'checked="checked"'; } ?> />
				<label for="<?php echo $this->get_field_id('disable_car'); ?>"><?php _e('Car', 'epl'); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id('disable_other'); ?>" name="<?php echo $this->get_field_name('disable_other'); ?>" type="checkbox" value="1" <?php if(isset($disable_other) && $disable_other) { echo 'checked="checked"'; } ?> />
				<label for="<?php echo $this->get_field_id('disable_other'); ?>"><?php _e('Other Search Options', 'epl'); ?></label>
			</p>
		<?php 
	}
}
