...
class EPL_Widget_Author_Testimonial extends WP_Widget {

	function __construct() {
		parent::WP_Widget( false, $name = __('EPL - Author Testimonial', 'epl') );	
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("EPL_Widget_Author_Testimonial");') );
