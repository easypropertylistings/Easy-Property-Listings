...
/**
 * EPL_Widget_Commercial_Property_Search class
 *
 * @since 1.0
 */
class EPL_Widget_Commercial_Property_Search extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$defaults = epl_commercial_search_get_defaults();
	...
	function update($new_instance, $old_instance) {
		...
		$all_fields = epl_commercial_search_widget_fields();
...
add_action( 'widgets_init', create_function('', 'return register_widget("EPL_Widget_Commercial_Property_Search");') );
