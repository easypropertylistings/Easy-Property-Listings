<?php
/*
 * Archive Template for Commercial Custom Post Type : eplp_commercial
 */
			...
			<h4 class="loop-title">
				<?php
					...
					if ( is_category() ) { // Category Archive
						...
						$title = sprintf( __( 'Commercial Property in %s', 'it-l10n-Builder-Coverage' ), builder_get_tax_term_title() );
					}
