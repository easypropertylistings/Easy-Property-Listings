...
// Pricing
if ( 'property' == $post_type || 'land' == $post_type || 'rural' == $post_type) {
	// Property Pricing and Specialised Meta Fields
	...
	} elseif ( '' != $property_price && 'yes' == $property_price_display ) {
		// Property
