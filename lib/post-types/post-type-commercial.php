...
function manage_epl_commercial_heading( $columns ) {
	$columns = array(
...
add_filter( 'manage_edit-epl_commercial_columns', 'manage_epl_commercial_heading' ) ;

function manage_epl_commercial_columns_value( $column, $post_id ) {
	global $post;
	switch( $column ) {
...
add_action( 'manage_epl_commercial_posts_custom_column', 'manage_epl_commercial_columns_value', 10, 2 );

// Manage Columns Sorting
function manage_epl_commercial_sortable_columns( $columns ) {
	$columns['property_status'] = 'property_status';
	$columns['property_address_suburb'] = 'property_address_suburb';
	return $columns;
}
add_filter( 'manage_edit-epl_commercial_sortable_columns', 'manage_epl_commercial_sortable_columns' );
