...
if(!class_exists('Post_Type_Template')) {
	...
	class Post_Type_Template {
		...
		private $_meta	= array( 'meta_a', 'meta_b', 'meta_c' );
		...
		public function add_meta_boxes() {
			...
			add_meta_box( sprintf('wp_plugin_template_%s_section', self::POST_TYPE), sprintf('%s Information', ucwords(str_replace("_", " ", self::POST_TYPE))), array(&$this, 'add_inner_meta_boxes'), self::POST_TYPE );					
