...
function manage_epl_property_columns_heading( $columns ) {
	$columns = array(
...
add_filter( 'manage_edit-epl_property_columns', 'manage_epl_property_columns_heading' ) ;

function manage_epl_property_columns_value( $column, $post_id ) {
	global $post;
	switch( $column ) {	
...
add_action( 'manage_epl_property_posts_custom_column', 'manage_epl_property_columns_value', 10, 2 );

// Manage Columns Sorting
function manage_epl_property_sortable_columns( $columns ) {
...
add_filter( 'manage_edit-epl_property_sortable_columns', 'manage_epl_property_sortable_columns' );
