...
function epl_register_custom_post_type_property() {
	...
	register_post_type( 'epl_property', $args );
}
add_action( 'init', 'epl_register_custom_post_type_property', 0 );

// Manage Listing Columns
function epl_manage_epl_property_columns_heading( $columns ) {
	$columns = array(
...
add_filter( 'manage_edit-epl_property_columns', 'epl_manage_epl_property_columns_heading' ) ;

function epl_manage_epl_property_columns_value( $column, $post_id ) {
	global $post;
	switch( $column ) {	
...
add_action( 'manage_epl_property_posts_custom_column', 'epl_manage_epl_property_columns_value', 10, 2 );

// Manage Columns Sorting
function epl_manage_epl_property_sortable_columns( $columns ) {
...
add_filter( 'manage_edit-epl_property_sortable_columns', 'epl_manage_epl_property_sortable_columns' );
