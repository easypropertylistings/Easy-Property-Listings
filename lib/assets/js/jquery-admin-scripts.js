jQuery(document).ready(
        function ($) {
			 ...
			 * @since 3.5.18 Google Maps API is loaded with loading=async, so it may not be ready when this runs on document.ready. Poll until ready.
                         */
                        admin_listings_map: function () {
                                ...
                                // Google Maps API is loaded with loading=async, so it may not
                                // be ready when this runs on document.ready. Poll until ready.
                                if (!window.google || !google.maps || !google.maps.LatLng) {
                                        if (typeof EPL_Admin._map_retries === 'undefined') {
                                                EPL_Admin._map_retries = 0;
                                        }
                                        if (EPL_Admin._map_retries < 50) {
                                                EPL_Admin._map_retries++;
                                                setTimeout(function () {
                                                        EPL_Admin.admin_listings_map();
                                                }, 200);
                                        }
                                        return false;
                                }
                                                ...
                                                $.ajax(
                                                        {
                                                                ...
                                                                success: function (response) {
                                                                        ...
                                                                        if (response.status === 'unauthorized') {
                                                                                alert('You do not have permission to feature this listing.');
                                                                                return;
                                                                        }
                                                        ...
                                                        update: function(event, ui) {
                                                                ...
                                                                $.ajax({
                                                                        data: {
                                                                                ...
                                                                                extension : extension,
                                                                                nonce: epl_admin_vars.ajax_nonce
                                                                        },
                                                                        type: "POST",
                                                                        url: ajaxurl,
                                                                });
