	...
	function($) {
		...
		var EPL_Admin = {
			...
			init_conditionals : function() {
				...
				let fields = $( '.epl-form-field-wrap input, .epl-form-field-wrap select, .epl-form-field-wrap textarea' );

				fields.each( function( index ) {

					let current_field = $(this);
					let current_container = current_field.closest('.epl-form-field-wrap');
					...
					let relation  = show.relation || 'AND';
					let conditions = show.fields || {};
			...
			handle_conditional_fields : function() {
				let to_check = $( '.epl-form-field-wrap input, .epl-form-field-wrap select, .epl-form-field-wrap textarea' );
