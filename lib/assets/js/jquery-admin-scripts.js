                ...
                */
                ...
                let EPL_Image_Manager = {
                        ...
                        add_image : function() {
                                ...
                                if ($('input[name="epl_carousel_upload_button"]').length > 0) {

                                        if (typeof wp !== 'undefined' && wp.media && wp.media.editor) {

                                            $(document).on('click', 'input[name="epl_carousel_upload_button"]', function(e) {

                                                e.preventDefault();
                                                var button = $(this);
                                                var carouselFrame = wp.media({
                                                ...
                                                carouselFrame.on("close",function() {
                                                        ...
                                                        selection.each(function(attachment) {
                                                                        ...
                                                                        var tpl = `
                                                                                <li class="ui-state-default epl_carousel_admin_thumb" data-id="`+attachment.id+`">
                                                                                        <span class="epl-slider-unattach">
                                                                                                <div class="epl-switch">
                                                                                                        <input type="checkbox" value="`+attachment.id+`" checked="checked" name="epl_carousel_enabled_thumbs[]" class="epl-cmn-toggle epl-cmn-toggle-round" id="epl-cmn-toggle-`+attachment.id+`">
                                                                                                        <label for="epl-cmn-toggle-`+attachment.id+`"></label>
                                                                                                </div>
                                                                                        </span>
                                                                                        <div class="epl-carousel-slide-tools">
                                                                                                <a target="_blank" href="post.php?post=`+attachment.id+`&action=edit">
                                                                                                        <span class="epl-carousel-edit-attach dashicons dashicons-edit"></span>
                                                                                                </a>
                                                                                                <a href="#" class="epl-slider-carousel-delete-attach">
                                                                                                        <span class="dashicons dashicons-trash"></span>
                                                                                                </a>
                                                                                        </div>
                                                                                        <img src="`+attachment.sizes[EPL_CAROUSELS.thumb_size].url+`">
                                                                                </li>
                                                                        `;
                                                                        $("#epl-carousel-post-attachments").append(tpl);
                                                        });
                                                });
                                                carouselFrame.open(button);
                                                return false;
                                            });
                                        }
                                }
                        ...
                        delete_image : function() {
                                ...
                                $(document).on( 'click', '.epl-slider-carousel-delete-attach', function(e) {
                                        e.preventDefault();
                            
                                    let parent = $(this).closest( '.epl_slider_admin_thumb' );
                                        let attach_id = parent.data( 'id' );
                            
                                    $.ajax({
                                        data: {
                                            id: $("#post_ID").val(),
                                            action: "epl_carousel_unattach",
                                            img_id : attach_id
                                        },
                                        type: "POST",
                                        url: ajaxurl,
