	...
	if ( !empty($links) ) {
		foreach ( $links as $k=>$link ) {
			if(!empty($link)) {
				...
				?><button type="button" class="epl-button epl-mini-web-link" onclick="location.href='<?php echo $link; ?>'"><?php echo apply_filters( 'epl_button_label_mini_web' , __('Mini Web ', 'easy-property-listings') ) . $number_string; ?></button><?php
			}
		}
	}
}
